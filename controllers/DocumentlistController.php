...
use app\models\content\DocumentItem;
...
class DocumentlistController extends Controller
{
    ...
    public function actionIndex($p)
    {
        ...
        try {
            $model = Documentlist::find()->where('page_has_template_id = '.$p)->one();
            if(!$model)
                throw new \yii\web\NotFoundHttpException("Documentlist not found");
            ...
            throw new ServerErrorHttpException("DocumentList nicht gefunden");
        }
    ...
    public function actionEditItem($p)
    {
        try {
            ...
            Yii::error('DocumentList - Error while saving EditItem: '.$e, __METHOD__);
    ...
    public function actionGetItem($p)
    {
        ...
        try {
            ...
            Yii::error('DocumentList - EditItem cannot be loaded: '.$e, __METHOD__);
    ...
    public function actionDelete($p)
    {
        ...
        try {
            ...
            $transaction->rollback();
            Yii::error("DownloadList (".$model->id.") konnte nicht gelöscht werden ". json_encode($model->getErrors()), __METHOD__);
            throw new ServerErrorHttpException("DocumentList konnte nicht gelöscht werden.");
        }
    ...
    public function actionGetFormData($p)
    {
        ...
        try {
            ...
            Yii::error('DocumentList - Error while loading: '.$e, __METHOD__);
            throw new \yii\web\BadRequestHttpException(Yii::t('errors', 'DATALOADINGERROR'));
        } catch (Exception $e) {
            Yii::error('DocumentList cannot be loaded: '.$e, __METHOD__);
            $topError = Yii::t('errors', 'DATALOADINGERROR');
        }
    }
